import { AuthenticationException, symbols } from '@adonisjs/auth'
  ...
  implements GuardContract<UserProvider[typeof symbols.PROVIDER_REAL_USER]>
{
   ...
   * credentials.
   */
  async attempt(uid: string, password: string): Promise<JSON> {
    /**
     * Find a user by uid
     */
   ...
   */
  async generate(user: UserProvider[typeof symbols.PROVIDER_REAL_USER]): Promise<JSON> {
